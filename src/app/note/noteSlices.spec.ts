...
describe('counter reducer', () => {
  ...
  it('should handle decrement', () => {
    const id = '1';
    const actual = counterReducer({...initialState, ...{'1': {id: '1'}} }, updateNote({id, card: {title: 'title', content: [{text: 'content'}]}}));
    expect(actual).toEqual({'1':{id: '1', title: 'title', content: [{text: 'content'}]} });
  });
});
